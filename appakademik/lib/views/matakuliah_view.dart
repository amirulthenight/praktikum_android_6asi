      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              futureMataKuliah.then((mataKuliahs) {
                generatePdf(mataKuliahs);
              });
            },
          ),
        ],
      ...
      body: FutureBuilder<List<MataKuliah>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('Data Mata Kuliah Kosong'));
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                subtitle: Text(
                  'Kode: ${mataKuliahs[index].kode}, SKS: ${mataKuliahs[index].sks}, Semester: ${mataKuliahs[index].semester}',
                ),
                trailing: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
